...
def parse_args() -> None:
    ...
    program.add_argument('--default_fps', help='video slice frame number selection', dest='default_fps', default='30', choices=['30', '60', '120'])
    ...
    roop.globals.default_fps = args.default_fps
