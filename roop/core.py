...
def parse_args() -> None:
    ...
    program.add_argument('--custom-fps', type=int, choices=[30, 60, 120], help='Custom FPS value (30, 60, 120, etc.)')
    ...
    roop.globals.custom-fps = args.custom-fps
...
def start() -> None:
    ...
    if roop.globals.keep_fps:
        ...
        custom-fps = args.custom_fps
        update_status(f'Extracting frames with {custom-fps} FPS...')
        extract_frames(roop.globals.target_path, custom-fps)
